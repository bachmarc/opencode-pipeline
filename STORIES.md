...
**Phases:** Retro (traceability) → 01 Foundation → 02 Self-Checks → 03 Deploy → 04 i18n
...
| 04-01-translate-agents | Translate agent/*.md to English | Planned | REQ-007, NFR-001 → Design §8 |
| 04-02-translate-commands | Translate command/*.md to English | Planned | REQ-007, NFR-001 → Design §8 |
| 04-03-translate-template | Translate templates/AGENTS.md to English | Planned | REQ-007, NFR-001 → Design §8 |
| 04-04-translate-repo-docs | Translate AGENTS.md + STORIES.md to English | Planned | REQ-007, NFR-001 → Design §8 |
