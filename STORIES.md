...
| 01-03-framework-checks | tests/test_framework.py (deterministic self-checks) | Geplant | REQ-003, REQ-004 → Design §3 |
| 01-04-deploy-procedure | Deployment doc (pull + restart) in README | Geplant | REQ-005 → Design §4 |
| 01-05-version | APP_VERSION.py + bump rule | Geplant | Design §6 |
